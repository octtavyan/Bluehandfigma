-- ============================================
-- SUPABASE COMPLETE SETUP - ALL TABLES
-- ============================================
-- Run this entire script in Supabase SQL Editor
-- It will create/update all necessary tables
...
DROP POLICY IF EXISTS "Allow authenticated insert to hero_slides" ON public.hero_slides;
DROP POLICY IF EXISTS "Allow authenticated update to hero_slides" ON public.hero_slides;
DROP POLICY IF EXISTS "Allow authenticated delete from hero_slides" ON public.hero_slides;
...
CREATE POLICY "Allow authenticated insert to hero_slides"
  ON public.hero_slides FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Allow authenticated update to hero_slides"
  ON public.hero_slides FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated delete from hero_slides"
  ON public.hero_slides FOR DELETE TO authenticated USING (true);
...
DROP POLICY IF EXISTS "Allow authenticated update to blog_posts" ON public.blog_posts;
DROP POLICY IF EXISTS "Allow authenticated delete from blog_posts" ON public.blog_posts;
...
CREATE POLICY "Allow authenticated update to blog_posts"
  ON public.blog_posts FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated delete from blog_posts"
...
SELECT 'Hero Slides:' as table_name, COUNT(*) as count FROM public.hero_slides;
